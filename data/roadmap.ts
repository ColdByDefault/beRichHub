...
// /data/resources.js
import { BookOpen, Youtube, BookMarked, Code2, Github, Database } from 'lucide-react';
export const resources = [
  ...
  },
  {
    ...
    Icon: Youtube,
    links: [
      { href: 'https://www.youtube.com/c/TraversyMedia', label: 'Traversy Media' },
      { href: 'https://www.youtube.com/c/TheNetNinja', label: 'The Net Ninja' },
      { href: 'https://www.youtube.com/c/Freecodecamp', label: 'freeCodeCamp' },
      { href: 'https://www.youtube.com/c/ProgrammingwithMosh', label: 'Programming with Mosh' },
  ...
  },
  {
    ...
    Icon: Github,
    links: [
      { href: 'https://github.com/firstcontributions/first-contributions', label: 'First Contributions' },
      ...
      { href: 'https://hacktoberfest.digitalocean.com/', label: 'Hacktoberfest' }
    ]
  },
  {
    id: 'tools',
