  ...
  return (
    <div className="flex flex-col flex-grow p-4 mt-12">
      <div className="fixed inset-0 pointer-events-none -z-1">
        ...
        />
        <div
          className={`absolute top-1/4 left-1/4 w-64 h-64 rounded-full blur-2xl animate-bounce ${logoGradient2}`}
          style={{ animationDuration: "3s" }}
        />
        <div
          className={`absolute bottom-1/4 right-1/4 w-48 h-48 rounded-full blur-2xl animate-pulse ${logoGradient3}`}
          style={{ animationDelay: "3s" }}
        />
      </div>
      <div
        className={`bg-gradient-to-r text-transparent flex justify-center text-8xl
