      ...
      <div className="space-y-6">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Learn about how we use cookies to enhance your experience and ensure
          ...
          <CardContent>
            <div className="bg-blue-50 dark:bg-blue-950/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
              <p className="text-sm text-blue-900 dark:text-blue-100 leading-relaxed">
                ...
                browser when you visit a website, used to remember your
                ...
                <div className="grid gap-3">
                  <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Kinde Auth cookies for secure authentication sessions
                  ...
                  <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Vercel hosting cookies for performance monitoring and
                        routing stability
                      </p>
                    </div>
                  </div>
                ...
                <div className="grid gap-3">
                  <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Store your UI theme choice (light/dark mode) for a
                  ...
                  <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground flex gap-2">
                        ...
                        GitHub OAuth cookies for seamless sign-in flows and
                        account linking
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Keep you signed in across visits and maintain your
                        session state
                      </p>
                    </div>
                  </div>
            ...
            <div className="space-y-4">
              <div className="bg-indigo-50 dark:bg-indigo-950/20 p-4 rounded-lg border border-indigo-200 dark:border-indigo-800">
                ...
                <p className="text-sm text-indigo-900 dark:text-indigo-100 leading-relaxed mb-3">
                  ...
                  manage or disable non-essential cookies at any time through
              ...
              <div className="bg-amber-50 dark:bg-amber-950/20 p-3 rounded-lg border border-amber-200 dark:border-amber-800">
                <div className="flex items-start gap-2">
                  <p className="text-xs text-amber-800 dark:text-amber-200">
                    ...
                    affect core functionality such as authentication and data
                    persistence.
                  </p>
                </div>
              </div>
